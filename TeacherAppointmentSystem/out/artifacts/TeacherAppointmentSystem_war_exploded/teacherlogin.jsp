...
<body>
<div class= "rg_layout">
    <form class="form-group" id="form" action="/TeacherAppointmentSystem_war_exploded/teacherLoginServlet" method="post">
        ...
        <input type="button" id="button" class="btn btn-primary btn-block" style="margin-top: 50px" value="教师登陆 ">
    </form>
    <br><br><br>
    <h7>--------------------其他用户登陆------------------</h7>
